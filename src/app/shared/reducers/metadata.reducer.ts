...
export function metadataReducer(state = initialState, action: Action) {
  switch (action.type) {
    case metadataActions.UPDATE_METADATA_TREE: {
    ...
    case metadataActions.UPDATE_METADATA_TREE_SUCCESS: {
      return Object.assign({}, state, {
